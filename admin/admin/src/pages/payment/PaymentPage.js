        ...
        <table className="table">
          ...
          <tbody>
            ...
            <tr key={index}>
              ...
              <td>{pay.siswa.kela.kelas} {pay.siswa.kela.jurusan}</td>
              <td>{Formatter.format(Date.parse(pay.createdAt))}</td>
              <td>{pay.bulan_bayar} - {pay.tahun_bayar}</td>
              <td><CurrencyFormat value={pay.jumlah_bayar} displayType={"text"} thousandSeparator={true} prefix={"Rp."}/></td>
              ...
              <td>
                <div className="dropdown table-action-dropdown">
                  ...
                  >
                    <li>
                      <Link to={`/editpayment/${pay.id_pembayaran}`} className="dropdown-item" href="#">
                    ...
                    <li>
                      <Link onClick={() => deletePayment(pay.id_pembayaran)} className="dropdown-item text-danger" href="#">
